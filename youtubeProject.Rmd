...
divas_pop <- rbind(gaga, rihanna, beyonce, kattyPerry, brineySpears, madonna, adele)

p <- plot_ly(kattyPerry, x = publishedAt, y = views, name = 'views', type = 'scatter', size=views,  mode = 'markers',  text = paste("Titulo: ", title)) 
