...
Utilizei uma métrica estatística simples, a média de views por número de vídeos. Iremos ver quem, dentre as maiores divas da música pop, é que possui mais views por vídeo. 
...
Segundo os dados, as colocações no nosso ranking mudaram, dentre os 21 canais das 21 maiores divas de todos os tempos (2008-2017), Adele possui uma média de, quase 183 milhões de views por vídeo, seguida pela Taylor Swift com quase 145 milhões de views em cada um dos seus 77 videos. Essa métrica não é muito confiável, visto que a quantidade de vídeos é bastante diferente entre os canais. Por isso, olhei mais umas informações para tentar encontrar a maior ou as maiores divas do YouTube. 
...
No gŕafico abaixo, é possível visualizar todo o histórico de das 20 maiores cantoras pops da história do YouTube.
```{r, message=F, warning=F,fig.width=10, fig.height=5}
#visualizações
